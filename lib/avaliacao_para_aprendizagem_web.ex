defmodule AvaliacaoParaAprendizagemWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: AvaliacaoParaAprendizagemWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {AvaliacaoParaAprendizagemWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import AvaliacaoParaAprendizagemWeb.CoreComponents
      import AvaliacaoParaAprendizagemWeb.Gettext
